...
class LoopDir(object):
	...
	def apply(self, function = None, directory = ".", actOnFiles = True, printOut = False, appendToList = True):
		"""	cycle through directory as indicated by "directory". If there is a 
			function assigned, each item will be pass through that function.
			...
			@param functions	function to be applied to items in directory
			@param actOnFiles	act on files if true or folders if false
