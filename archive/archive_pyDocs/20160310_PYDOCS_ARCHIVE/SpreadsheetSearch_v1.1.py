...
if __name__ == "__main__":
    ...
    """
    import os, time, InfoText, SpreadsheetSearchLog
    ...
    excerptFile = "files\\20151022\\ling-excerpts-all-ascensionprovidence.txt"          # Path to file containing excerpts
    droolsRules = "files\\droolsrules.txt"                                              # Path to file containing DROOLS Rules
    nameNewFile = "Sample-ling-excerpts-all-AscensionProvidence-Glenn-2000-PROCESSED"   # Name of file to output information to
    
    col1, col2, col3 = "Eval", "AddToDB", "Notes"                           # Labels for the new columns to be added to the spreadsheet
    ...
    print it.spreadsheetSearch(version = 1.1)
    print it.location()
    print it.separator()
