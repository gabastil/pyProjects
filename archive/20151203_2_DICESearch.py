# Name: DICESearch.py
# Version: 1.1 (updated: 2015/12/03: changed list in isSufficient() to generator)
...
class DICESearch(Compiler, SpreadsheetSearch):
	...
	def isSufficient(self, dbPath = "L:\DICE Documents\JoshsAwesomeScript\search-keywords-all.txt"):
		...
		dbCheckResultsList = ((d, index(x)+1) for d, v in keywords for x in kernel if lower(v) in x)
